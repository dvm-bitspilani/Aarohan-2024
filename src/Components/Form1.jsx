...
export default function Form1() {
  ...
  const state_options = state_arr.map((state, index = 1) => {
    ++index;
    return (
  ...
  const city_options = s_a[stateIndex].split("|").map((city) => {
  ...
  // console.log(
  //     name, fatherName, school, inClass, city, state, email
  // )
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://bits-apogee.org/2024/main/aarohan/studentreg/",
        formData,
      );
      ...
      <form className="form" id="form1">
        ...
        <div className="information">
          ...
          {/* <br/>
                    ...
                    The last date for registration is the 12th of November, 2024.
                    <br/>
